		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method = "post" action = "server.php">
					...
					<br> all students are given a loan of 1000 when making a new account<br> 
					&nbsp;
					...
					<div class="wrap-input100 validate-input" data-validate="Account is required">
						...
						<input class="input100" type="text" name="account" placeholder="Type your account name">
						<span class="focus-input100" data-symbol="&#x41;"></span>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Your Password Again:</span>
						<input class="input100" type="password" name="password_2" placeholder="Type your password again">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
